        ...
        <div className="container">
            ...
            agents.map((agent) => (
                ...
                <div className="team-item rounded overflow-hidden">
                    ...
                    <Link to={`/agentdetail/${agent._id}`}> <img className="img-fluid" src={agent.agentimage} style={{height:"300px", width:"300px"}} alt=""/></Link>
                        <div className="position-absolute start-50 top-100 translate-middle d-flex align-items-center">
                            <a className="btn btn-square mx-1" href=" "><i className="fab fa-facebook-f"></i></a>
                            <a className="btn btn-square mx-1" href=" "><i className="fab fa-twitter"></i></a>
                            <a className="btn btn-square mx-1" href=" "><i className="fab fa-instagram"></i></a>
                            <Link className="btn btn-square mx-1" to={`/check`} title="Appontments" onClick={()=>localStorage.setItem('Agent',agent.id)}>{apposCount[agent.id]}</Link>
                        </div>
                    </div>
