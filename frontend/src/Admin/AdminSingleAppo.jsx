...
const AdminSingleAppo = () => {
    ...
    useEffect(() => {
        ...
        fetch(`http://localhost:8000/api/book/getdatass/${id}`,{
            method:"GET",
        })
        .then(res => res.json())
        .then((userData)=>{
    ...
    <div class="container-fluid header bg-white p-0">
            <div class="row g-0 align-items-center flex-column-reverse flex-md-row">
                <div class="col-md-6 p-5 mt-lg-5">
                    <h1 class="display-5 animated fadeIn mb-4">Agent Appointments</h1> 
        ...
        <div className="table-wrapper">
            ...
            <table className="table table-striped table-hover" ref={ref}>
                ...
                {userData.map((userData) => (
                        <tr key={userData._id}>  
                        <td> {userData.propertyDetails.agentusername}</td>
                        <td> {userData.name}</td>
...
export default AdminSingleAppo