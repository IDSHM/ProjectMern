                    ...
                    <div className="col-md-4">
                        <div className="product p-4">
                            <div className="d-flex justify-content-between align-items-center">
                                ...
                                <span className="ml-1"><Link to="/adminp_list">Back</Link></span> 
                                </div> 
                      ...
                      <div className="text-start mx-auto mb-5 wow slideInLeft" data-wow-delay="0.1s">
                          ...
                          {/* <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Delectus est alias iste aspernatur exercitationem iure sit. Hic dignissimos harum suscipit!</p> */}
                            ...
                            <form>
                                ...
                                <input type="text" id="name" placeholder="Enter Your Name" onInput={handleChange}/>
                                <br />
                                <br />
                                <input type="email" id="email" placeholder="Enter Your Email" onInput={handleChange}/>
                                <br />
                                <br />
                                <input type="number" id="phone" placeholder="Enter Your Phone Number" onInput={handleChange}/>
                                <br />
                                <br />
                                <input type="text" id="message" placeholder="Some Information.." onInput={handleChange}/>
                                <br />
                                <br />
                            </form>
