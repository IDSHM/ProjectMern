...
<div className="container register">
                <div className="row">
                    <div className="col-md-3 register-left">
                        ...
                        <Link to="/dashboard"><input type="submit" name="" value="Dashboard"/></Link><br/>
                    </div>
                    <div className="col-md-9 register-right">
                        <div className="tab-content" id="myTabContent">
                            <div className="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                <h3 className="register-heading">Add User</h3>
                                ...
                                <div className="row">
                                    ...
                                    <div className="col-md-12">
                                          <div className="form-group" id="agent"  style={{display: 'none'}}>
                                            <label className='labelReg'>AgentUserName</label><br/>
                                  ...
                                  <input type="submit" className="btnRegister" value="Add User"/>
