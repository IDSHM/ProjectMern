...
export class userlist extends Component {
  render() {
    ...
    <div class="hero-wrap" style={{backgroundImage: "url('images/bg_1.jpg')"}}>
          ...
          <div class="col-lg-8">
          	<div class="row">
          		<div class="col-md-12 ftco-animate">
          			<div class="single-slider carousel">
          				<div class="item">
          					<div class="properties-img" style={{backgroundImage: "url(images/properties-1.jpg)"}}></div>
          				</div>
          				{/* <div class="item">
          					<div class="properties-img" style={{backgroundImage: "url(images/properties-2.jpg)"}}></div>
          				</div>
          				<div class="item">
          					<div class="properties-img" style={{backgroundImage: "url(images/properties-3.jpg)"}}></div>
          				</div> */}
          			</div>
          		</div>
          			...
          			<div class="row">
          				<div class="col-md-6 ftco-animate">
				    				<div class="properties">
				    					<a href="property-single.html" class="img img-2 d-flex justify-content-center align-items-center" style={{backgroundImage: "url(images/properties-1.jpg)"}}>
				    			...
				    			<div class="col-md-6 ftco-animate">
				    				<div class="properties">
				    					<a href="property-single.html" class="img img-2 d-flex justify-content-center align-items-center" style={{backgroundImage: "url(images/properties-2.jpg)"}}>
				    						<div class="icon d-flex justify-content-center align-items-center">
				    							<span class="icon-search2"></span>
				    						</div>
				    					</a>
