            ...
            <div id="tab-1" className="tab-pane fade show p-0 active">
                ...
                .map((product) => (
                    <div className="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                        <div className="property-item rounded overflow-hidden">
                            <div className="position-relative overflow-hidden">
                                <Link to={`/usersingle/${product._id}`}><img className="" src={product.image} alt="" style={{height:"300px", width:"100%"}}/></Link>
                    ...
                    <div className="col-12 text-center wow fadeInUp" data-wow-delay="0.1s">
                        <Link className="btn btn-warning py-3 px-5" to="/userp_list">Browse More Property</Link>
                    </div>
                </div>
            </div>
        </div>
...
"Take the first step towards your dream property by reaching out to our experienced and certified agents today."</p>
                        ...
                        <Link to="/usercontact" className="btn btn-warning py-3 px-4 me-2"><i class="fa-solid fa-phone"></i>Make A Call</Link>
                        <Link to="/usercontact" className="btn btn-dark py-3 px-4"><i className="fa fa-calendar-alt me-2"></i>Get Appoinment</Link>
                    </div>
                </div>
            </div>
        </div>
        ...
        agents.map((agent) => (
            <div className="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                <div className="team-item rounded overflow-hidden">
                    ...
                    <Link to="/userp_agent"> <img className="img-fluid" src={agent.agentimage} style={{height:"300px", width:"300px"}} alt=""/></Link>
                        <div className="position-absolute start-50 top-100 translate-middle d-flex align-items-center">
                            <a className="btn btn-square mx-1" href=" "><i className="fab fa-facebook-f"></i></a>
                            <a className="btn btn-square mx-1" href=" "><i className="fab fa-twitter"></i></a>
                            <a className="btn btn-square mx-1" href=" "><i className="fab fa-instagram"></i></a>

                            <Link className="btn btn-square mx-1" to="" title="Appontments">{apposCount[agent.id]}</Link>
