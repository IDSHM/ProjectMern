...
<div className="container-fluid header bg-white p-0">
    <div className="row g-0 align-items-center flex-column-reverse flex-md-row">
        <div className="col-md-6 p-5 mt-lg-5">
            <br /><br /><br />
            <h1 className="display-5 animated fadeIn mb-4">Agent Details</h1> 
                <nav aria-label="breadcrumb animated fadeIn">
                <ol className="breadcrumb text-uppercase">
                    <li className="breadcrumb-item"><a href="# ">Home</a></li>
                    <li className="breadcrumb-item"><a href="# ">Pages</a></li>
                    <li className="breadcrumb-item text-body active" aria-current="page">Agent</li>
                </ol>
            </nav>
        </div>
                ...
                <div className="row">
                    <div className="col-md-8">
                        <div className="images p-3">
                            ...
                            <img id="main-image" src={agents.agentimage} width="600" height="500" alt='' /> 
                            </div>
                    ...
                    <div className="col-md-4">
                        <div className="product p-4">
                            <div className="d-flex justify-content-between align-items-center">
                                ...
                                <span className="ml-1"><Link to="/userp_agent">Back</Link></span> 
                                </div> 
