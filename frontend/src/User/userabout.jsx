        ...
        <div className="container-fluid nav-bar bg-transparent">
            ...
            <Link to="/userhome" className="navbar-brand d-flex align-items-center text-center">
                ...
                <div className="collapse navbar-collapse" id="navbarCollapse">
                    ...
                    {/* <Link to="" className="btn btn-warning px-3 d-none d-lg-flex">Get Appointment</Link>
                &nbsp;&nbsp;&nbsp;&nbsp; */}
...
"Take the first step towards your dream property by reaching out to our experienced and certified agents today."</p>
                                ...
                                <a href="/usercontact" className="btn btn-warning py-3 px-4 me-2"><i class="fa-solid fa-phone"></i>Make A Call</a>
                                <a href="/usercontact" className="btn btn-dark py-3 px-4"><i className="fa fa-calendar-alt me-2"></i>Get Appoinment</a>
                            </div>
                        </div>
                    </div>
                </div>
